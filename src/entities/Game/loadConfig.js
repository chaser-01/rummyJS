...
/*
Contains all functions that are used for initializing the game object.
...
export function initializePlayers(game, playerIds){
    let players = [];
    for (const playerId of playerIds){
        players.push(new playerId(game, playerId));
    }
    return players;
}
